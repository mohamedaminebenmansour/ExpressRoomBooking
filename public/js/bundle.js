...
exports.resetPasswrd = exports.forgotPasswrd = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var forgotPasswrd = exports.forgotPasswrd = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'ok') {
            console.log(res);
            (0, _alerts.showAlert)('success', 'go to email');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
  ...
  return function forgotPasswrd(_x) {
    return _ref.apply(this, arguments);
  };
}();
var resetPasswrd = exports.resetPasswrd = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(password, passwordConfirm) {
    var pathname, segments, lastSegment, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          console.log("reset passwrd");
          pathname = window.location.pathname; // Split the pathname by "/" and get the last segment
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:3000/api/v1/users/resetPassword/".concat(lastSegment),
            data: {
              password: password,
              passwordConfirm: passwordConfirm
            }
  ...
  return function resetPasswrd(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"room.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateRoom = exports.deleteRoom = exports.addRoom = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:3000/api/v1/rooms/".concat(roomID),
            data: {}
          });
        case 5:
          res = _context.sent;
          if (res.data.status === 'ok') {
            console.log(res);
            (0, _alerts.showAlert)('success', 'Delete it');
            window.setTimeout(function () {
...
var addRoom = exports.addRoom = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'ok') {
            console.log(res);
            (0, _alerts.showAlert)('success', 'add it');
            window.setTimeout(function () {
              location.assign('/managerooms');
            }, 1500);
          }
  ...
  return function addRoom(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
var updateRoom = exports.updateRoom = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(roomId, data, type) {
    var res;
  ...
  return function updateRoom(_x3, _x4, _x5) {
...
exports.updateBook = exports.deleteRoom = exports.createBook = exports.addRoom = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var createBook = exports.createBook = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(roomId, data) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "http://127.0.0.1:3000/api/v1/rooms/".concat(roomId, "/reservations"),
            data: data
          });
        case 4:
          res = _context.sent;
          console.log("success");
          if (res.data.status === "ok") {
            (0, _alerts.showAlert)("success", "book successfully!");
            window.setTimeout(function () {
              location.assign("/");
            }, 1000);
          }
...
var deleteRoom = exports.deleteRoom = /*#__PURE__*/function () {
  ...
  return function deleteRoom(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
/*
...
var addRoom = exports.addRoom = /*#__PURE__*/function () {
  ...
  return function addRoom(_x4) {
    return _ref3.apply(this, arguments);
  };
}();
var updateBook = exports.updateBook = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(bookId, data) {
    var res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:3000/api/v1/reservations/".concat(bookId),
            data: data
          });
        case 4:
          res = _context4.sent;
...
var formRoomDelete = document.querySelector('.form-room-delete');
var formAddRoom = document.querySelector('.form--add-room');
var formAddBook = document.querySelector('.form--add-book');
var formRoomUpdate = document.querySelector('.form-room-update');
var formUserDelete = document.querySelector('.form-user-delete');
var formUpdateBook = document.querySelector('.form--update-book');
...
if (resetForm) resetForm.addEventListener('submit', function (e) {
  ...
  var password = document.getElementById('password').value;
  var passwordConfirm = document.getElementById('passwordConfirm').value;
  (0, _auth.resetPasswrd)(password, passwordConfirm);
});
...
if (formRoomUpdate) formRoomUpdate.addEventListener('submit', function (e) {
  e.preventDefault();
  ...
  var priceDiscount = parseInt(document.getElementById('priceDiscount').value);
  var summary = document.getElementById('summary').value;
  var description = document.getElementById('description').value;
  var coordinates = document.getElementById('coordinates').value.split(',').map(function (coord) {
  ...
  var imageCoverFile = document.getElementById('imageCover').files[0];
  var image1File = document.getElementById('image1').files[0];
  var image2File = document.getElementById('image2').files[0];
  var image3File = document.getElementById('image3').files[0];
  if (imageCoverFile) {
  ...
  (0, _room.updateRoom)(roomId, formData, 'data');
});
...
if (formAddRoom) formAddRoom.addEventListener('submit', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    var name, capacity, price, priceDiscount, summary, description, coordinates, address, locationDescription, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          e.preventDefault();
          ...
          priceDiscount = parseInt(document.getElementById('priceDiscount').value);
          summary = document.getElementById('summary').value;
          description = document.getElementById('description').value;
          coordinates = document.getElementById('coordinates').value.split(',').map(function (coord) {
            return parseFloat(coord.trim());
          });
          address = document.getElementById('address').value;
          locationDescription = document.getElementById('locationDescription').value; // Construct JSON object
          data = {
            name: name,
            capacity: capacity,
            price: price,
...
if (formRoomDelete) formRoomDelete.addEventListener('submit', /*#__PURE__*/function () {
...
if (formUserDelete) formUserDelete.addEventListener('submit', /*#__PURE__*/function () {
...
if (formAddBook) formAddBook.addEventListener('submit', /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
    var room, startDate, duration, data;
...
if (formUpdateBook) formUpdateBook.addEventListener('submit', /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
    var bookId, startDate, duration, data;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          (0, _book.updateBook)(bookId, data);
        case 10:
        case "end":
